...
//methods for supplier number to capture into notepad
public static void capturesup(String LocatorType,String LocatorValue )throws Throwable
{
	String SupplierkNum = "";
	if(LocatorType.equalsIgnoreCase("name"))
	{
		SupplierkNum = driver.findElement(By.name(LocatorValue)).getAttribute("value");	
	}
	if(LocatorType.equalsIgnoreCase("id"))
	{
		SupplierkNum = driver.findElement(By.id(LocatorValue)).getAttribute("value");	
	}
	if(LocatorType.equalsIgnoreCase("xpath"))
	{
		SupplierkNum = driver.findElement(By.xpath(LocatorValue)).getAttribute("value");	
	}
//create notepad
	FileWriter fw = new FileWriter("./CaptureData/supplierNumber.txt");
	BufferedWriter bw = new BufferedWriter(fw);
	bw.write(SupplierkNum);
	bw.flush();
	bw.close();
}
...
public static void cutsomerTable()throws Throwable
{
